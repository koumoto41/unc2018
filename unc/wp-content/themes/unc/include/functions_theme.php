...
function moesia_scripts()
{
    ...
    wp_enqueue_script('moesia-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206',
        true);
    ...
    if (is_page_template('page_front-page.php')) {
        ...
        wp_enqueue_style('moesia-pretty-photo',
            get_template_directory_uri() . '/inc/prettyphoto/css/prettyPhoto.min.css');

        wp_enqueue_script('moesia-pretty-photo-js',
            get_template_directory_uri() . '/inc/prettyphoto/js/jquery.prettyPhoto.min.js', array(), true);

        wp_enqueue_script('moesia-pretty-photo-init',
            get_template_directory_uri() . '/inc/prettyphoto/js/prettyphoto-init.js', array(), true);
    ...
    wp_enqueue_script('moesia-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js',
        array(), '20130115', true);
    ...
    if (is_home() && get_theme_mod('blog_layout') == 'masonry') {
        wp_enqueue_script('moesia-masonry-init', get_template_directory_uri() . '/js/masonry-init.js', array('masonry'),
            true);
    }
...
{
    wp_enqueue_style('moesia-bootstrap', get_template_directory_uri() . '/css/bootstrap/bootstrap.min.css', array(),
        true);
}
...
function moesia_image_upload($post)
{
    ...
    wp_enqueue_script('moesia-image-upload', get_template_directory_uri() . '/js/image-uploader.js', array('jquery'),
        true);
...
if (!function_exists('moesia_nav_bar')) {
    ...
    {
        echo '<div class="top-bar"><div class="container menu_block">';
        echo '<h1><a href="'.home_url().'"><img src="'.THEME_URL.'/images/unc_logo_s.png" alt="'.DEF_TITLE.'"></a></h1>';
