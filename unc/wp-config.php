...
if (isset( $_SERVER['SERVER_NAME'] ) == true) {
	if ($_SERVER['SERVER_NAME'] == 'natural-camp.test') {
...
// キーワードデフォルト
define('DEF_KEYWORDS',   '牛窓ナチュラルキャンプ,牛窓ナチュラルキャンプ2017,うしまど,岡山県,瀬戸内市,黒島,無人島');
// ディスクリプションデフォルト
...
// LIVE STAGE配列
$aryCommonStage = array('treestage'=>'TreeStage', 'littleforest'=>'LittleForest', 'littleiviza'=>'LittleIviza', 'unkown'=>'Unkown');